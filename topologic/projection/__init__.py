...
The function return type Callable[[nx.Graph, MetadataTypeRegistry], Callable[[List[str]], None]] is the cornerstone
...
to update and the MetadataTypeRegistry to update.
...
- Values are always stored as type str, but could be a more narrowly bounded type like int or float.  The type registry
should safely tell you what you can cast a given metadata attribute as.
